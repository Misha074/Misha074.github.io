...
var _buyFood = require("./modules/dragfood/buyFood");
// ---------------------------------
...
},{"./modules/dragfood/buyFood":2,"./modules/form-validate/form":7,"./modules/modals/init-modals":13,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var _dragfood = require("./dragfood");
var _dragFoodTouch = require("./dragFoodTouch");
var buyFood = exports.buyFood = function buyFood() {
  if (window.matchMedia('(pointer: coarse)').matches) {
    (0, _dragFoodTouch.dragFoodTouch)();
  } else {
    (0, _dragfood.dragFood)();
  }
};

},{"./dragFoodTouch":3,"./dragfood":4}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dragFoodTouch = void 0;
var _showPaymentButton = require("./showPaymentButton");
var dragFoodTouch = exports.dragFoodTouch = function dragFoodTouch() {
  var foods = document.querySelectorAll('.food');
  var cart = document.querySelector('.cart');
  var cartInner = document.querySelector('.cart__incart-food');
  ...
  var initialPosition = {
    left: 0,
    top: 0
  }; // Для хранения начальной позиции элемента
  ...
  function onTouchMove(event) {
    ...
    var rect = activeFood.parentNode.getBoundingClientRect();
  ...
  function onTouchEnd() {
    ...
    var rectCart = cart.getBoundingClientRect();
    var rectFood = activeFood.getBoundingClientRect();
    if (rectFood.left < rectCart.right && rectFood.right > rectCart.left && rectFood.top < rectCart.bottom && rectFood.bottom > rectCart.top) {
      cartInner.append(activeFood);
      activeFood.style.left = '0';
      activeFood.style.top = '0';
      if (cartInner.children.length >= 3) {
        (0, _showPaymentButton.showPaymentButton)();
      }
    } else {
      activeFood.style.left = '0';
      activeFood.style.top = '0';
...
},{"./showPaymentButton":5}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dragFood = void 0;
var _showPaymentButton = require("./showPaymentButton");
...
var dragFood = exports.dragFood = function dragFood() {
  var foods = document.querySelectorAll('.food');
  var cart = document.querySelector('.cart');
  var cartInner = document.querySelector('.cart__incart-food');
  ...
  cart.addEventListener('drop', function (e) {
    ...
    var inCartFoodId = e.dataTransfer.getData('foodId'); // Получаем id перетаскиваемого продукта
    var inCartfood = document.getElementById(inCartFoodId); // Находим элемент по id
...
},{"./showPaymentButton":5}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showPaymentButton = void 0;
var showPaymentButton = exports.showPaymentButton = function showPaymentButton() {
