...
require("./modules/filter-buttons-active/filter-buttons-active");
...
var _inputValidateModal = require("./modules/input-validate-modal/input-validate-modal");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _inputValidateModal.inputValidateModal)();
...
var btns = filter.querySelectorAll('.filter__button');

// Loop through the buttons and add the active class to the current/clicked button
for (var i = 0; i < btns.length; i++) {
  btns[i].addEventListener('click', function () {
    var current = document.querySelectorAll('.filter__button--active');
...
exports.inputValidateModal = inputValidateModal;
var feedbackForm = document.getElementById('feedbackform-modal');
var inputName = feedbackForm.querySelector('[type="text"]');
var inputTel = feedbackForm.querySelector('[type="tel"]');
var inputCheckbox = feedbackForm.querySelector('[type="checkbox"]');
var customCheckbox = document.getElementById('custom-checkbox-modal');
var submitButton = feedbackForm.querySelector('[type="submit"]');
...
},{"../../utils/focus-lock":19,"../../utils/scroll-lock":22}],11:[function(require,module,exports){
"use strict";
...
var links = nav.querySelectorAll('.nav__item-link');
