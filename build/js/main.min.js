...
/* harmony import */ var _modules_init_sliders_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-sliders.js */ "./js/modules/init-sliders.js");
/* harmony import */ var _modules_init_menu_directions_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-menu-directions.js */ "./js/modules/init-menu-directions.js");
/* harmony import */ var _modules_init_advantages_filter_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-advantages-filter.js */ "./js/modules/init-advantages-filter.js");
...
/* harmony import */ var _modules_init_scrollbar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-scrollbar */ "./js/modules/init-scrollbar.js");
/* harmony import */ var _modules_init_scrollbar__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_init_scrollbar__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _modules_swiper_professions_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/swiper-professions.js */ "./js/modules/swiper-professions.js");
/* harmony import */ var _modules_school_cut_text_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/school-cut-text.js */ "./js/modules/school-cut-text.js");
/* harmony import */ var _modules_reviews_reviews_show_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/reviews/reviews-show.js */ "./js/modules/reviews/reviews-show.js");
/* harmony import */ var _modules_reviews_review_cutting_text_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/reviews/review-cutting-text.js */ "./js/modules/reviews/review-cutting-text.js");
/* harmony import */ var _modules_reviews_reviews_swiper_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/reviews/reviews-swiper.js */ "./js/modules/reviews/reviews-swiper.js");
/* harmony import */ var _modules_reviews_review_replace_modal_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/reviews/review-replace-modal.js */ "./js/modules/reviews/review-replace-modal.js");
/* harmony import */ var _modules_achievements_tabs_swiper_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/achievements-tabs-swiper.js */ "./js/modules/achievements-tabs-swiper.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_init_menu_directions_js__WEBPACK_IMPORTED_MODULE_5__["initMenuDirections"])();
  Object(_modules_init_advantages_filter_js__WEBPACK_IMPORTED_MODULE_6__["initAdvantagesFilter"])();
  Object(_modules_init_sliders_js__WEBPACK_IMPORTED_MODULE_4__["initSliders"])();
  Object(_modules_school_cut_text_js__WEBPACK_IMPORTED_MODULE_10__["initCourseCutText"])();
  Object(_modules_swiper_professions_js__WEBPACK_IMPORTED_MODULE_9__["initProfessionsSwiper"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_achievements_tabs_swiper_js__WEBPACK_IMPORTED_MODULE_15__["initAchievementsTabsSwiper"])();
    ...
    window.form = form;
    form.init();
    Object(_modules_reviews_review_replace_modal_js__WEBPACK_IMPORTED_MODULE_14__["replaceReviewModals"])();
    Object(_modules_reviews_review_cutting_text_js__WEBPACK_IMPORTED_MODULE_12__["reviewCuttingText"])();
    Object(_modules_reviews_reviews_swiper_js__WEBPACK_IMPORTED_MODULE_13__["initReviewsSwiper"])();
  ...
  window.addEventListener('resize', function () {
    Object(_modules_school_cut_text_js__WEBPACK_IMPORTED_MODULE_10__["courseCutText"])();
    Object(_modules_reviews_review_cutting_text_js__WEBPACK_IMPORTED_MODULE_12__["reviewCuttingText"])();
    Object(_modules_reviews_reviews_swiper_js__WEBPACK_IMPORTED_MODULE_13__["initReviewsSwiper"])();
    Object(_modules_achievements_tabs_swiper_js__WEBPACK_IMPORTED_MODULE_15__["initAchievementsTabsSwiper"])();
    Object(_modules_swiper_professions_js__WEBPACK_IMPORTED_MODULE_9__["initProfessionsSwiper"])();
...
/***/ "./js/modules/achievements-tabs-swiper.js":
/*!************************************************!*\
  !*** ./js/modules/achievements-tabs-swiper.js ***!
  \************************************************/
/*! exports provided: initAchievementsTabsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAchievementsTabsSwiper", function() { return initAchievementsTabsSwiper; });
/* harmony import */ var _tabs_init_tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tabs/init-tabs */ "./js/modules/tabs/init-tabs.js");

var swiper; // Объявляем переменную в области видимости функции, чтобы иметь к ней доступ позже, и сделать дестрой.

function initAchievementsTabsSwiper() {
  var achievements = document.querySelector('.achievements');
  if (achievements) {
    var achievementsSwiper = achievements.querySelector('.achievements__swiper');
    var achievementsTabs = achievements.querySelector('.achievements__tabs');
    var tabsContent = achievements.querySelector('.achievements__tabs-content');
    var tabsElement = achievements.querySelectorAll('.achievements__tabs-element');
    var tabsElementFirst = achievements.querySelector('.achievements__tabs-element');
    var tabsButton = achievements.querySelectorAll('.tabs__control');
    var tabsButtonFirst = achievements.querySelector('.tabs__control');
    if (document.documentElement.clientWidth < 768 && !achievementsSwiper.classList.contains('achievements__swiper--inited')) {
      ...
      tabsElement.forEach(function (elem) {
    ...
    if (document.documentElement.clientWidth >= 768 && achievementsSwiper.classList.contains('achievements__swiper--inited')) {
      ...
      Object(_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_0__["initTabs"])();
...
/***/ "./js/modules/init-advantages-filter.js":
/*!**********************************************!*\
  !*** ./js/modules/init-advantages-filter.js ***!
  \**********************************************/
/*! exports provided: initAdvantagesFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAdvantagesFilter", function() { return initAdvantagesFilter; });
var initAdvantagesFilter = function initAdvantagesFilter() {
  if (document.querySelector('[data-advantages="filter"]')) {
    var filter = document.querySelector('[data-advantages="filter"]');
    var filterElements = filter.querySelectorAll('[data-advantages="filter-item"]');
    var selectElement = function selectElement(evt) {
      var parentElement = evt.currentTarget;
      var currentElement = parentElement.closest('label').querySelector('input');
      var titleCurrentElement = parentElement.closest('label').querySelector('input').value;
      var svgElement = parentElement.querySelector('use');
      var svgUrlElement = svgElement.getAttribute('xlink:href');
      var titleTextColorElement = parentElement.closest('label').querySelector('.custom-toggle__label');
      if (svgUrlElement === "#".concat(titleCurrentElement, "-colorless")) {
        svgElement.setAttribute('xlink:href', "#".concat(titleCurrentElement, "-color"));
        currentElement.setAttribute('checked', '');
        titleTextColorElement.classList.add("custom-toggle__label--".concat(titleCurrentElement));
      } else {
        svgElement.setAttribute('xlink:href', "#".concat(titleCurrentElement, "-colorless"));
        currentElement.removeAttribute('checked');
        titleTextColorElement.classList.remove("custom-toggle__label--".concat(titleCurrentElement));
      }
    };
    var onFilterElementClick = function onFilterElementClick(evt) {
      selectElement(evt);
    };
...
/***/ "./js/modules/init-menu-directions.js":
/*!********************************************!*\
  !*** ./js/modules/init-menu-directions.js ***!
  \********************************************/
/*! exports provided: initMenuDirections */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMenuDirections", function() { return initMenuDirections; });
/* harmony import */ var _vendor_init_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/init-accordion */ "./js/vendor/init-accordion.js");

var initMenuDirections = function initMenuDirections() {
  if (window.matchMedia('(max-width: 767px)').matches) {
    var accordionElements = document.querySelectorAll('[data-modal="burger"] [data-directions="submenu"]');
    var mobileAccordionElements = Array.from(accordionElements).slice(accordionElements.length / 2);
    for (var i = 0; i < mobileAccordionElements.length; i++) {
      var submenuItems = mobileAccordionElements[i].querySelectorAll('.list__item');
      if (submenuItems.length > 7) {
        submenuItems = Array.from(submenuItems).map(function (el, index) {
          if (index % 2 || index > 12) {
    ...
    Object(_vendor_init_accordion__WEBPACK_IMPORTED_MODULE_0__["initAccordions"])();
  } else {
    var directionMenu = document.querySelector('[data-directions="menu"]');
    var directionMenuElements = directionMenu.querySelectorAll('[data-directions="submenu"]');
    var activeSubMenu = 0;
    var _loop = function _loop(_i) {
      var onDocumentKeydown = function onDocumentKeydown(evt) {
        if (evt.key === 'Escape') {
          evt.preventDefault();
          closeDirectionElement(_i);
        }
      };
      var onCloseClickDocument = function onCloseClickDocument(evt) {
        if (!evt.target.closest('[data-directions="submenu"].is-active')) {
          closeDirectionElement(_i);
        }
      };
      var onDirectionElClick = function onDirectionElClick() {
        if (activeSubMenu === 0) {
          openDirectionElement();
        } else {
          for (var j = 0; j < directionMenuElements.length; j++) {
            closeDirectionElement(j);
          }
          openDirectionElement();
        }
      };
      var openDirectionElement = function openDirectionElement() {
        directionMenuElements[_i].classList.add('is-active');
        activeSubMenu = directionMenuElements[_i].querySelector('ul');
        activeSubMenu.classList.add('is-active');
        document.addEventListener('keydown', onDocumentKeydown);
        document.addEventListener('click', onCloseClickDocument);
      };
      var closeDirectionElement = function closeDirectionElement(count) {
        directionMenuElements[count].classList.remove('is-active');
        activeSubMenu.classList.remove('is-active');
      };
      directionMenuElements[_i].addEventListener('click', onDirectionElClick);
    };
    for (var _i = 0; _i < directionMenuElements.length; _i++) {
      _loop(_i);
    }
  }
};
...
var listsArray = document.querySelectorAll('[data-list="group-list"]');
if (listsArray) {
  for (var i = 0; i < listsArray.length; i++) {
    var itemsArray = listsArray[i].querySelectorAll('li');
    if (itemsArray.length > 5) {
      listsArray[i].classList.add('checkbox__list--scroll');
      var totalHeight = 0;
      var elementMargin = 0;
      for (var j = 0; j < 5; j++) {
        var elementHeight = itemsArray[j].offsetHeight;
      ...
      listsArray[i].style.height = "".concat(totalHeight, "px");
    }
  }
}
...
var initSliders = function initSliders() {
  var slider = document.querySelectorAll('[data-range-slider]');
  var inputMin = document.querySelectorAll('[name="from"]');
  var inputMax = document.querySelectorAll('[name="to"]');
  var resetBtnElements = document.querySelectorAll('[data-reset]');
  if (slider) {
    var _loop = function _loop(i) {
      var minRange = parseInt(inputMin[i].getAttribute('data-min'), 10);
      var maxRange = parseInt(inputMax[i].getAttribute('data-max'), 10);
      ...
      _vendor_nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(slider[i], {
      ...
      var tooltipInputMin = slider[i].querySelector('[data-handle]').querySelector('.noUi-tooltip');
      slider[i].noUiSlider.on('update', function () {
        var array = slider[i].noUiSlider.get();
      ...
      inputMin[i].addEventListener('change', function () {
        slider[i].noUiSlider.set([inputMin[i].value, null]);
      });
      inputMax[i].addEventListener('change', function () {
        slider[i].noUiSlider.set([null, inputMax[i].value]);
      });
      for (var j = 0; j < resetBtnElements.length; j++) {
        resetBtnElements[j].addEventListener('click', function () {
...
/***/ "./js/modules/reviews/review-cutting-text.js":
/*!***************************************************!*\
  !*** ./js/modules/reviews/review-cutting-text.js ***!
  \***************************************************/
/*! exports provided: reviewCuttingText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reviewCuttingText", function() { return reviewCuttingText; });
var reviews = document.querySelector('.reviews');
var reviewsTextsArray = document.querySelectorAll('.review__main-text');
var fullTexts = Array.from(reviewsTextsArray).map(function (element) {
  return element.textContent;
});
function reviewCuttingText() {
  if (document.documentElement.clientWidth < 768) {
    reviewsTextsArray.forEach(function (element) {
      var text = element.textContent;
      var cuttedText = text.slice(0, 394);
      element.textContent = cuttedText + '...';
    });
  } else {
    reviewsTextsArray.forEach(function (element, index) {
...
/***/ "./js/modules/reviews/review-replace-modal.js":
/*!****************************************************!*\
  !*** ./js/modules/reviews/review-replace-modal.js ***!
  \****************************************************/
/*! exports provided: replaceReviewModals */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "replaceReviewModals", function() { return replaceReviewModals; });
var reviews = document.querySelector('.reviews');
...
function replaceReviewModals() {
  if (reviews && document.documentElement.clientWidth < 768) {
    while (reviews.querySelector('.modal')) {
      var currentReplacingModal = reviews.querySelector('.modal');
...
/***/ "./js/modules/reviews/reviews-show.js":
/*!********************************************!*\
  !*** ./js/modules/reviews/reviews-show.js ***!
  \********************************************/
/*! exports provided: showThreeReviews */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showThreeReviews", function() { return showThreeReviews; });
var reviews = document.querySelector('.reviews');
var reviewsList = document.querySelector('.reviews__list');
var showMoreButton = document.querySelector('.reviews__show-more-button');
function showThreeReviews() {
  for (var i = 0; i < 3; i++) {
    var review = reviewsList.querySelector('.reviews__list-item--unshowed');
    if (review) {
...
/***/ "./js/modules/reviews/reviews-swiper.js":
/*!**********************************************!*\
  !*** ./js/modules/reviews/reviews-swiper.js ***!
  \**********************************************/
...
/* harmony import */ var _reviews_show__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reviews-show */ "./js/modules/reviews/reviews-show.js");
...
var reviewsList = document.querySelector('.reviews__list');
var showMoreButton = document.querySelector('.reviews__show-more-button');
var swiperButtons = document.querySelector('.reviews__swiper-buttons-container');
...
function initReviewsSwiper() {
  ...
  if (swiper && document.documentElement.clientWidth < 768) {
    var allReviews = reviewsList.querySelectorAll('.reviews__list-item');
    allReviews.forEach(function (element) {
  ...
  if (reviewsSwiper && document.documentElement.clientWidth >= 768) {
    ...
    var _allReviews = reviewsList.querySelectorAll('.reviews__list-item');
    _allReviews.forEach(function (element) {
      element.classList.add('reviews__list-item--unshowed');
    });
    Object(_reviews_show__WEBPACK_IMPORTED_MODULE_0__["showThreeReviews"])();
...
/***/ "./js/modules/school-cut-text.js":
/*!***************************************!*\
  !*** ./js/modules/school-cut-text.js ***!
  \***************************************/
/*! exports provided: initCourseCutText, courseCutText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCourseCutText", function() { return initCourseCutText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "courseCutText", function() { return courseCutText; });
var fullSchoolText;
var fullDescriptionText;
var initCourseCutText = function initCourseCutText() {
...
var courseCutText = function courseCutText() {
  if (document.querySelector('.course-info')) {
    var schoolText = document.querySelector('[data-school="text"] p');
    var courseDescriptionText = document.querySelector('[data-description="text"] p');
...
/***/ "./js/modules/swiper-professions.js":
/*!******************************************!*\
  !*** ./js/modules/swiper-professions.js ***!
  \******************************************/
/*! exports provided: initProfessionsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initProfessionsSwiper", function() { return initProfessionsSwiper; });
var professionsSwiper;
function initProfessionsSwiper() {
  var swiper = document.querySelector('.professions__swiper');
  if (swiper && document.documentElement.clientWidth < 768) {
